...
//							"_seed" + String.valueOf(seed);
	...
	FuzzyTermType[] DBWR2;
	FuzzyTermType[] DWWR2;
	FuzzyTermType[] DBTMR2;
	FuzzyTermType[] DWTMR2;
...
//		EBWR.setCombination("WA");
		...
		DBSN_param2 = new float[][] {{0f, 0.21f}, {1f, 0.21f}, {0.08f, 0.2f}, {0.16f, 0.2f}, {0.24f, 0.2f}, {0.32f, 0.2f}};
		DWSN_param2 = new float[][] {{0f, 0.21f}, {1f, 0.21f}, {0.08f, 0.2f}, {0.16f, 0.2f}, {0.24f, 0.2f}, {0.32f, 0.2f}};
		DBWR_param2 = new float[][] {{0f, 0.21f}, {1f, 0.21f}, {0.3f, 0.05f}, {0.4f, 0.05f}, {0.5f, 0.05f}, {0.6f, 0.05f}};
		DWWR_param2 = new float[][] {{0f, 0.21f}, {1f, 0.21f}, {0.4f, 0.05f}, {0.5f, 0.05f}, {0.6f, 0.05f}, {0.7f, 0.05f}};
		DBTMR_param2 = new float[][] {{0f, 0.21f}, {1f, 0.21f}, {0.66f, 0.1f}, {0.72f, 0.1f}, {0.78f, 0.1f}, {0.84f, 0.1f}};
		DWTMR_param2 = new float[][] {{0f, 0.21f}, {1f, 0.21f}, {0.66f, 0.1f}, {0.72f, 0.1f}, {0.78f, 0.1f}, {0.84f, 0.1f}};
		...
		DBSN2 = new FuzzyTermType[6];
		DBSN2[0] = new FuzzyTermType("left", FuzzyTermType.TYPE_gaussianShape, new float[] {0f, 0.21f});
		DBSN2[1] = new FuzzyTermType("right", FuzzyTermType.TYPE_gaussianShape, new float[] {1f, 0.21f});
		DBSN2[2] = new FuzzyTermType("one", FuzzyTermType.TYPE_gaussianShape, new float[] {0.08f, 0.2f});
		DBSN2[3] = new FuzzyTermType("two", FuzzyTermType.TYPE_gaussianShape, new float[] {0.16f, 0.2f});
		DBSN2[4] = new FuzzyTermType("three", FuzzyTermType.TYPE_gaussianShape, new float[] {0.24f, 0.2f});
		DBSN2[5] = new FuzzyTermType("four", FuzzyTermType.TYPE_gaussianShape, new float[] {0.32f, 0.2f});

		DWSN2 = new FuzzyTermType[6];
		DWSN2[0] = new FuzzyTermType("left", FuzzyTermType.TYPE_gaussianShape, new float[] {0f, 0.21f});
		DWSN2[1] = new FuzzyTermType("right", FuzzyTermType.TYPE_gaussianShape, new float[] {1f, 0.21f});
		DWSN2[2] = new FuzzyTermType("one", FuzzyTermType.TYPE_gaussianShape, new float[] {0.08f, 0.2f});
		DWSN2[3] = new FuzzyTermType("two", FuzzyTermType.TYPE_gaussianShape, new float[] {0.16f, 0.2f});
		DWSN2[4] = new FuzzyTermType("three", FuzzyTermType.TYPE_gaussianShape, new float[] {0.24f, 0.2f});
		DWSN2[5] = new FuzzyTermType("four", FuzzyTermType.TYPE_gaussianShape, new float[] {0.32f, 0.2f});

		DBWR2 = new FuzzyTermType[6];
		DBWR2[0] = new FuzzyTermType("left", FuzzyTermType.TYPE_gaussianShape, new float[] {0f, 0.21f});
		DBWR2[1] = new FuzzyTermType("right", FuzzyTermType.TYPE_gaussianShape, new float[] {1f, 0.21f});
		DBWR2[2] = new FuzzyTermType("one", FuzzyTermType.TYPE_gaussianShape, new float[] {0.3f, 0.05f});
		DBWR2[3] = new FuzzyTermType("two", FuzzyTermType.TYPE_gaussianShape, new float[] {0.4f, 0.05f});
		DBWR2[4] = new FuzzyTermType("three", FuzzyTermType.TYPE_gaussianShape, new float[] {0.5f, 0.05f});
		DBWR2[5] = new FuzzyTermType("four", FuzzyTermType.TYPE_gaussianShape, new float[] {0.6f, 0.05f});

		DWWR2 = new FuzzyTermType[6];
		DWWR2[0] = new FuzzyTermType("left", FuzzyTermType.TYPE_gaussianShape, new float[] {0f, 0.21f});
		DWWR2[1] = new FuzzyTermType("right", FuzzyTermType.TYPE_gaussianShape, new float[] {1f, 0.21f});
		DWWR2[2] = new FuzzyTermType("one", FuzzyTermType.TYPE_gaussianShape, new float[] {0.4f, 0.05f});
		DWWR2[3] = new FuzzyTermType("two", FuzzyTermType.TYPE_gaussianShape, new float[] {0.5f, 0.05f});
		DWWR2[4] = new FuzzyTermType("three", FuzzyTermType.TYPE_gaussianShape, new float[] {0.6f, 0.05f});
		DWWR2[5] = new FuzzyTermType("four", FuzzyTermType.TYPE_gaussianShape, new float[] {0.7f, 0.05f});

		DBTMR2 = new FuzzyTermType[6];
		DBTMR2[0] = new FuzzyTermType("left", FuzzyTermType.TYPE_gaussianShape, new float[] {0f, 0.21f});
		DBTMR2[1] = new FuzzyTermType("right", FuzzyTermType.TYPE_gaussianShape, new float[] {1f, 0.21f});
		DBTMR2[2] = new FuzzyTermType("one", FuzzyTermType.TYPE_gaussianShape, new float[] {0.66f, 0.1f});
		DBTMR2[3] = new FuzzyTermType("two", FuzzyTermType.TYPE_gaussianShape, new float[] {0.72f, 0.1f});
		DBTMR2[4] = new FuzzyTermType("three", FuzzyTermType.TYPE_gaussianShape, new float[] {0.78f, 0.1f});
		DBTMR2[5] = new FuzzyTermType("four", FuzzyTermType.TYPE_gaussianShape, new float[] {0.84f, 0.1f});

		DWTMR2 = new FuzzyTermType[6];
		DWTMR2[0] = new FuzzyTermType("left", FuzzyTermType.TYPE_gaussianShape, new float[] {0f, 0.21f});
		DWTMR2[1] = new FuzzyTermType("right", FuzzyTermType.TYPE_gaussianShape, new float[] {1f, 0.21f});
		DWTMR2[2] = new FuzzyTermType("one", FuzzyTermType.TYPE_gaussianShape, new float[] {0.66f, 0.1f});
		DWTMR2[3] = new FuzzyTermType("two", FuzzyTermType.TYPE_gaussianShape, new float[] {0.72f, 0.1f});
		DWTMR2[4] = new FuzzyTermType("three", FuzzyTermType.TYPE_gaussianShape, new float[] {0.78f, 0.1f});
		DWTMR2[5] = new FuzzyTermType("four", FuzzyTermType.TYPE_gaussianShape, new float[] {0.84f, 0.1f});
