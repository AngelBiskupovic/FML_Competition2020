...
import main.ItemSet;
import main_cilabo_ver4_featureSelection.ga.Optimization_KB;
import main_cilabo_ver4_featureSelection.ga.Optimization_RB;
...
//		ItemSet Deva = train;
		...
		// ************************************************************
		/* 3. GA Loop */
		for(int i = 0; i < Main.generalFrameRepeatTime; i++) {
			System.out.println();
			System.out.println("************************");
